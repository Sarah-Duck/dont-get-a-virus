function loadDia()
  ...
  if virus1Lose == 0 then
    ...
    v1.msgs[13] = "HAHA! PATHETIC! Is that it? Is that all you got? I bet that thing couldn't put a dent in me!"
    v1.msgs[14] = "Go ahead! Try it, you won't stop me!"
    v1.msgs[15] = "Grab it by the blue bar, position it below me, and press the spacebar! Go on! DO IT!"
